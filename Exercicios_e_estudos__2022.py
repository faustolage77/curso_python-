...
# contador = 0  #  atribuindo meu contador
# nova_string = ''
#
#
# while contador < tamanho_frase:  # determinando um critério de iteraçao
#     print(frase[contador], contador)   #  determinando que o programa imprima a frase com meu contador e meu contador
#     #  neste caso o índice buscado dentro da frase será o próprio contador
#     #  ou seja, pela logica, o contador ao ser iterado irá imprimir uma letra e depois a proxima e a proxima
#     # e assim sucessivamente ate o fim do loop
#     nova_string = nova_string + frase[contador] #  determinando que a string vazia vai acumular o proprio valor + o valor do contadr
#     contador = contador + 1
#
# print(nova_string)
...
# frase = "Hoje irei treinar na academia "
# tamanho_frase = len(frase)
# print(tamanho_frase)
# contador = 0
# nova_frase = ''  #  criando uma string vazia para receber os caracteres
#
# while contador < tamanho_frase:
#     nova_frase = nova_frase + frase[contador]  #  utilizando o contador para atuar como índice
#     contador = contador + 1
#     print(nova_frase)
#
...
# #     c += 1
#
# for letra in enumerate(texto):  #  usando a funcao enumerante
#     print(letra)


###########
#
# #  a funçao range - start, stop, step
#
# for numero in range(0, 100, 8):  #  usando a funcao range para criar um raio de abrangencia
#     #  aqui ele começa no 5, termina no 10 e pula de 1 em 1
#     #  step negativa: contagem de tras p frente
#     print(numero)
#
# #  encontrar os multiplos de 8


# ######
#
# texto = "Python"
# nova_string = ""  #  criando uma stting vazia para funcionar como acumuladora
#
# for letra in texto:
#     if letra == "t":
#         nova_string = nova_string + letra.upper()
#     elif letra == "h":   #  definindo qual letra eu quero manipular
...
#############
#
# Lista de exercicios http://www.facom.ufu.br/~backes/gbt017/ListaPython05.pdf

# 3. Fac¸a um programa para converter uma letra maiuscula em letra min ´ uscula. Use a tabela ´
...
# 4. Crie um programa que compara duas strings. #  compare como? o comprimento?
...
# print(nome[0:4])  #  lembrando que o programa nao lerá o ultimo indice do meu comando, ele para em uma casa anterior
...
# nome = input("diga seu nome: ")
#
# sexo = input("diga seu sexo M ou F: ")
#
# while sexo != "F" and sexo != "M":
#     print(input("responda com F ou M: "))
#     sexo = input("diga seu sexo M ou F: ")  #  ao repetir a variavel aqui eu saio do loop caso o usuario digite correto
#
# idade = input("diga sua idade: ")
# idade = int(idade)  #  convertendo de string para inteiro
#
